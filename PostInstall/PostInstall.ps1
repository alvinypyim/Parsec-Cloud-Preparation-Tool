...
function download-resources {
    ...
    (New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/Swemoph/Cloud-GPU-Updater/86be7610a54f422515beaf258c14e9585084377c/GPUUpdaterTool.ps1", "$env:ProgramData\ParsecLoader\GPUUpdaterTool.ps1")
